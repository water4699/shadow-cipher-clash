...
class FhevmDecryptionSignatureStorageKey {
    ...
    constructor(instance, contractAddresses, userAddress, publicKey) {
        ...
        const emptyEIP712 = instance.createEIP712(publicKey ?? ethers_1.ethers.ZeroAddress, sortedContractAddresses, 0, 0);
        try {
            const hash = ethers_1.ethers.TypedDataEncoder.hash(emptyEIP712.domain, { UserDecryptRequestVerification: emptyEIP712.types.UserDecryptRequestVerification }, emptyEIP712.message);
