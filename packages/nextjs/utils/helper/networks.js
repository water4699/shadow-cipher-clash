...
const getAlchemyHttpUrl = (chainId) => {
    return scaffold_config_1.default.alchemyApiKey && exports.RPC_CHAIN_NAMES[chainId]
...
function getTargetNetworks() {
    return scaffold_config_1.default.targetNetworks.map(targetNetwork => ({
        ...targetNetwork,
        ...exports.NETWORKS_EXTRA_DATA[targetNetwork.id],
    }));
}
